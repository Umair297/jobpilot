...
class SettingsController extends Controller
{
    ...
    public function pwaUpdate(Request $request)
    {
        ...
        // Check if user cleared the image using dropify
        if ($request->input('delete_app_pwa_icon') == '1') {
            deleteFile($setting->app_pwa_icon);
            $setting->app_pwa_icon = ''; // Use empty string instead of null
        }
