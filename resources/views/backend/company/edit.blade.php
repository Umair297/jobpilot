                        ...
                        <div class="row">
                            <div class="form-group col-xl-4">
                                ...
                                <input name="logo" type="file" class="dropify"
                                    data-default-file="{{ $company->logo_url }}">
                            ...
                            <div class="form-group col-xl-8">
                                ...
                                <input name="image" type="file" class="dropify"
                                    data-default-file="{{ $company->banner_url }}">
                                <input type="hidden" name="remove_image" id="remove_image" value="0">
                                <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">
                                    Recommended Image Size: 1920x312
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="form-group col-md-4">
                                    <select
                                        ...
                                        <option {{ old('social_media')=='twitter' ? 'selected' : '' }} value="twitter">
                                            {{ __('twitter') }}</option>
                                        <option {{ old('social_media')=='instagram' ? 'selected' : '' }}
                                            value="instagram">{{ __('instagram') }}
                                        </option>
                                        <option {{ old('social_media')=='youtube' ? 'selected' : '' }} value="youtube">
                                            {{ __('youtube') }}</option>
                                        ...
                                        <option {{ old('social_media')=='reddit' ? 'selected' : '' }} value="reddit">{{
                                            __('reddit') }}</option>
                                        <option {{ old('social_media')=='github' ? 'selected' : '' }} value="github">{{
                                            __('github') }}</option>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="organization_type_id"
                                    ...
                                    <option {{ $type->id == old('organization_type_id', $company->organization_type_id)
                                        ? 'selected' : '' }}
                                        value="{{ $type->id }}">
                                        {{ $type->name }}
                                    </option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="industry_type_id"
                                    ...
                                    <option {{ $type->id == old('industry_type_id', $company->industry_type_id) ?
                                        'selected' : '' }}
                                        value="{{ $type->id }}">
                                        {{ $type->name }}
                                    </option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="team_size_id" class="form-control {{ error('team_size_id') }}"
                                    ...
                                    <option {{ $size->id == old('team_size_id', $company->team_size_id) ? 'selected' :
                                        '' }}
                                        value="{{ $size->id }}">
                                        {{ $size->name }}
                                    </option>
...
var logoDropify = $('input[name="logo"]').dropify();
logoDropify.on('dropify.afterClear', function(event, element){
    $('#remove_logo').val(1);
});

var imageDropify = $('input[name="image"]').dropify();
