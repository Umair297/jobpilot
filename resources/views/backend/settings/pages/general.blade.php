            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('settings.general.update') }}" method="POST"
                    ...
                    <div class="row ">
                        ...
                        <input type="hidden" name="delete_light_logo" id="delete_light_logo" value="0" />
                    ...
                    {{-- <div class="row mt-3">
                        ...
                        <div class="col-sm-4">
                            <label class="image-container">
                                <input type="radio" name="landing_page" id="1" value="1" {{ $setting->landing_page == 1
                                ? 'checked' : '' }}>
                                <img class="full-image" src="{{ asset('backend/image/landing-page-01.png') }}" alt="">
                                <span class="checked-badge"></span>
                            </label>
                        </div>
                        <div class="col-sm-4">
                            <label class="image-container">
                                <input type="radio" name="landing_page" id="2" value="2" {{ $setting->landing_page == 2
                                ? 'checked' : '' }}>
                                <img class="full-image" src="{{ asset('backend/image/landing-page-02.png') }}" alt="">
                            </label>
                        </div>
                        <div class="col-sm-4">
                            <label class="image-container">
                                <input type="radio" name="landing_page" id="3" value="3" {{ $setting->landing_page == 3
                                ? 'checked' : '' }}>
                                <img class="full-image" src="{{ asset('backend/image/landing-page-03.png') }}" alt="">
                            </label>
                        </div>
                    </div> --}}
                ...
                <form class="form-horizontal" action="{{ route('settings.pwa.update') }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <input type="hidden" name="delete_app_pwa_icon" id="delete_app_pwa_icon" value="0" />
...
<script>
    function changeCountryType(value) {
        ...
        // Dropify clear detection

   $('.dropify').on('dropify.beforeClear', function(event, element) {
    const inputName = $(this).attr('name'); // e.g. dark_logo
    // Use name selector to set hidden input value
    $(`input[name="delete_${inputName}"]`).val('1');
});
